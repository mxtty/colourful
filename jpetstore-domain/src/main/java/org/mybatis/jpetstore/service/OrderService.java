...
import org.mybatis.jpetstore.domain.entity.LineItemEntity;
import org.mybatis.jpetstore.domain.entity.OrderEntity;
...
public class OrderService {
	...
	public OrderEntity createEntity() {
		this.orderEntity = ContextProvider.getBean(OrderEntity.class);
		return orderEntity;
	}
