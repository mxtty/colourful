package org.mybatis.jpetstore.security;
...
public class CustomUserDetailsServiceImpl implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException, DataAccessException {
		...
		System.out.println("List size is ---------------" + clm.getAllCodeList().size());
		try {
			...
			user = new User("wang", "e08392bb89dedb8ed6fb298f8e729c15", true, true, true, true, getAuthorities());
