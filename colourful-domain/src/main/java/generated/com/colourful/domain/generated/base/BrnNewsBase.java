...
import com.colourful.domain.generated.mapper.BrnNewsMapper;
...
public class BrnNewsBase extends BrnNews {

	/** 管理Mapper */
	@Autowired
	private BrnNewsMapper mapper;
	...
	public boolean getEntityByPk() {
		BrnNews detail = mapper.readByPk(this);
		if (null == detail) {
			return false;
		}
