...
import com.colourful.domain.generated.mapper.BrnCartDetailMapper;
...
public class BrnCartDetailBase extends BrnCartDetail {

	/** 管理Mapper */
	@Autowired
	private BrnCartDetailMapper mapper;
	...
	public boolean getEntityByPk() {
		BrnCartDetail detail = mapper.readByPk(this);
		if (null == detail) {
			return false;
		}
