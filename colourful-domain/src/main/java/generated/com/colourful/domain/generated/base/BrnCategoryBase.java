...
import com.colourful.domain.generated.mapper.BrnCategoryMapper;
 ...
 * 
 */
public class BrnCategoryBase extends BrnCategory {

	/** SerialVersion */
	private static final long serialVersionUID = 353526016654509629L;

	/** 管理Mapper */
	@Autowired
	private BrnCategoryMapper mapper;
	...
	public boolean getEntityByPk() {
		BrnCategory detail = mapper.readByPk(this);
		if (null == detail) {
			return false;
		}
