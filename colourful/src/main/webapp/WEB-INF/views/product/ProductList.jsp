...
<div class="block-4 col-3">
	<form:form id="product_list_form" method="post"  modelAttribute="registerUserForm" action="registerUser/register">
		<div class="h2"><h2 class="h2-line-2">${catetoryName}</h2></div>

		<div class="box-4 border-3">
		<c:forEach var="product" items="${productsList}">
			<div>
				<h4>${product.productName}</h4>
				<div class="img-border"><img src="image/imageDisplay/${product.picturePath}" /></div>
				<div class="price">¥11.8/份 </div>
				<a href="buy/${product.productId}" class="myButton addToCartBtn" >加入购物车</a>
			</div>
		</c:forEach>
		</div>
