...
<div class="col-5">
    ...
    <div id="orderFinish" class="info-detail" >
          <label><strong class="right width-10">订单号:</strong><strong class="left width-10"><a href="order/ViewOrder/${orderEntryForm.cartId}/${orderEntryForm.orderId}">${orderEntryForm.orderId}</a></strong></label>
