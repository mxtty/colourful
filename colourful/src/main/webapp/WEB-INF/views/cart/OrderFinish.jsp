...
<div class="col-5">
	...
	<form:form id ="ship_form" method="get" action="cart/orderFinish" modelAttribute="orderEntryForm">
    <div id="orderFinish" class="info-detail" >
          <label><strong class="right width-10">订单号:</strong><strong class="left width-10"><a href="cart/ViewOrder/${orderEntryForm.cartId}/${orderEntryForm.orderId}">${orderEntryForm.orderId}</a></strong></label>
          <label><strong class="right width-10">联系人:</strong><strong class="left width-10"><c:out value ="${orderEntryForm.shipName}"> </c:out></strong></label>
