        ...
        <div class="col-5">
			...
			<form:form id ="ship_form" method="post" action="cart/orderFinish" modelAttribute="orderEntryForm">
              <fieldset>
                ...
                <label><strong class="right width-10">送货时间:</strong><form:input  path="shipDate" class="width250" placeholder="请输入送货时间"/><strong class="clear"></strong></label>
                <label><strong class="right width-10">送货地点:</strong><form:textarea path="shipAddress" cols="35" rows="4" class="width250" maxlength="200" placeholder="请输入送货地点"></form:textarea><strong class="clear"></strong></label>
               </fieldset>  
