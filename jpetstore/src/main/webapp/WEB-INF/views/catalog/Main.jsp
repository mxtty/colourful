...
<div id="SidebarContent"><a href="category/find/FISH">
	<img src="<c:url value="/resources/images/fish_icon.gif"/>" />
</a>
 <br />
Saltwater, Freshwater <br />
<a href="category/find/DOGS">
	<img src="<c:url value="/resources/images/dogs_icon.gif"/>" />
</a> <br />
Various Breeds <br />
<a href="category/find/CATS">
	<img src="<c:url value="/resources/images/cats_icon.gif"/>" />
</a> <br />
